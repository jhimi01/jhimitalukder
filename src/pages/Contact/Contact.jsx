...
const Contact = () => {
  return (
    <div className="md:flex items-center justify-center gap-10">
      ...
      <div className="w-full md:w-1/2 md:mt-0 mt-5 mx-auto md:pl-5">
        <h2 className="text-5xl md:text-start text-center mb-3">
          Send <span className="text-indigo-500">Email</span>
        </h2>
        <form action="https://formspree.io/f/xdovqllq" method="POST">
          <div className="mb-4">
